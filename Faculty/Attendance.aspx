<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/Faculty.master" AutoEventWireup="true" CodeFile="Attendance.aspx.cs" Inherits="Faculty_Attendance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <section class="content-header">
        <h1>All Students List<small>(Take Attendance)</small></h1>       
 </section>
            ...
            <div class="box box-primary" style="min-height:400px">
               <%-- <div class="box-header">
                ...
                <div class="box-body">                                 
                    ...
                    <div class="col-md-12">
                        <div class="form-group"> 
                             <asp:Button ID="btnSelect" CssClass="btn btn-danger" runat="server" OnClick="btnSelect_Click" Text="Select All" />
                            <asp:Button ID="btnsave" style="margin-left:10px;" runat="server" CssClass="btn btn-primary" OnClick="btnsave_Click" Text="Save"></asp:Button>
                        </div>
                        <div class="form-group"> 
                        ...
                        <asp:GridView ID="grdDetails" CssClass="table table-striped table-bordered table-hover" runat="server" 
                            ...
                            <Columns>
                                ...
                                <ItemTemplate> 
                                    ...
                                    <asp:HiddenField ID="hdStudentID" runat="server" Value='<%#Eval("ID")%>'/>                          
                                </ItemTemplate>
                            </asp:TemplateField>
                            </Columns>
