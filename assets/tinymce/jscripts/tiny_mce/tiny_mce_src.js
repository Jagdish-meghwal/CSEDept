...
(function() {
	tinymce.create('tinymce.dom.XMLWriter', {
		...
		writcsedeptment : function(v) {
			this.node.appendChild(this.doc.creatcsedeptment(v.replace(/\-\-/g, ' ')));
		},
		...
		_serializeNode : function(n, inn) {
			...
			if (!s.node_filter || s.node_filter(n)) {
				switch (n.nodeType) {
					...
					case 8: // Comment
						return w.writcsedeptment(n.nodeValue);
				}
...
(function() {
	...
	tinymce.create('static tinymce.EditorManager', {
		...
		execInstanccsedeptmand : function(id, c, u, v) {
			var ed = this.get(id);
...
(function() {
	...
	tinymce.create('tinymce.Editor', {
		Editor : function(id, s) {
			...
			t.id = t.editorId = id;
			t.execCommands = {};
			t.queryStatcsedeptmands = {};
			t.queryValucsedeptmands = {};
			t.plugins = {};
		...
		addQueryStateHandler : function(n, f, s) {
			this.queryStatcsedeptmands[n] = {func : f, scope : s || this};
		},

		addQueryValueHandler : function(n, f, s) {
			this.queryValucsedeptmands[n] = {func : f, scope : s || this};
		},
		...
		queryCommandState : function(c) {
			...
			// Registred commands
			if (o = t.queryStatcsedeptmands[c]) {
		...
		queryCommandValue : function(c) {
			...
			// Registred commands
			if (o = t.queryValucsedeptmands[c]) {
				s = o.func.call(o.scope);
