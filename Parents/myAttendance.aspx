<%@ Page Title="" Language="C#" MasterPageFile="~/Parents/Parents.master" AutoEventWireup="true" CodeFile="myAttendance.aspx.cs" Inherits="Parents_myAttendance" %>
                   ...
                   <div class="row" style="padding:10px;">
                       ...
                       <div  class="col-md-6">
                        <div class="form-group">      
                         ...
                         <div class="col-md-6">
                        <asp:TextBox ID="txtfromsearch" class="form-control" runat="server" placeholder="Select from Date"></asp:TextBox>
                             
                              <asp:CalendarExtender ID="CalendarExtender1" CssClass="cal_Theme1" runat="server" TargetControlID="txtfromsearch" Format="yyyy-MM-dd"></asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" ControlToValidate="txtfromsearch" ErrorMessage="Please Select Date" ForeColor="Red"></asp:RequiredFieldValidator>     
                    </div>
                       <br />
                       <div class="col-md-6">
                        <asp:TextBox ID="txttosearch" class="form-control" runat="server" placeholder="Select To Date"></asp:TextBox>
                             
                              <asp:CalendarExtender ID="CalendarExtender2" CssClass="cal_Theme1" runat="server" TargetControlID="txttosearch" Format="yyyy-MM-dd"></asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txttosearch" ErrorMessage="Please Select Date" ForeColor="Red"></asp:RequiredFieldValidator>     
                    </div> 
                 <div class="col-md-6">
