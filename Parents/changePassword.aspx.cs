...
public partial class Parents_changePassword : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string oldpass = csedept.ExecuteScalar("Select ParentsLoginPassword from StudentTbl where Id='" + Aid + "' and ParentsLoginPassword='" + OldPassword + "' and IsActive='1'");
            if (OldPassword == oldpass)
            {
                string NewPassword = txtNewPassword.Text;
                csedept.ExecuteQuery("Update StudentTbl set ParentsLoginPassword ='" + NewPassword + "' where Id='" + Aid + "' ");
