<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.master" AutoEventWireup="true" CodeFile="ManageFeedBackQues.aspx.cs" Inherits="Admin_ManageFeedBackQues" %>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body"> 
                <div class="form-group">                          
                    ...
                    <asp:TextBox ID="txtques" CssClass="form-control" required="require" TextMode="MultiLine" runat="server" ></asp:TextBox>                          
                </div> 
